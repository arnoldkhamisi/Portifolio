...
const projects = [
  ...
  },
  {
    ...
    description: 'A clean and intuitive weather application that fetches real-time weather data from an API and displays it in a beautiful interface.',
  ...
  },
  {
    ...
    image: '/img/Trevor\'s Kitchen 1.png',
    url: '/img/Trevor\'s Kitchen 1.png',
  },
  {
    title: 'Sunrise Cafe',
  ...
  },
  {
    ...
    url: '/img/trade fare exhibition.png',
  },
  {
    title: 'Fifo-Kleen Ad',
    description: 'A vibrant promotional video ad designed with a bold yellow theme to capture instant attention. The ad uses clean motion graphics, smooth transitions, and modern typography to deliver a clear, engaging message.',
    image: '/img/placeholder-7.png',
    url: '/img/fifo-kleen ad.mp4',
  },
];
...
const skills = [
  ...
  'DB Management (phpMyAdmin, MongoDb, MySQL & XAMPP)',
        ...
        <section id="about" className="section-padding flex flex-col items-center text-center">
          <div className="max-w-xl mx-auto">
            ...
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              I am a driven Full-Stack Developer and IT Professional with a strong foundation in building dynamic web applications and managing technical infrastructure. With hands-on experience across the entire development lifecycle, I specialize in crafting clean front-end interfaces, developing robust back-end logic, and designing efficient database architectures.
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              My technical expertise extends beyond software development into systems administration and networking; operating comfortably in Linux environments, I enjoy the challenge of bridging the gap between high-quality code and reliable infrastructure—whether that means deploying scalable web platforms, configuring virtual environments, or troubleshooting hardware and network systems.
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              I am passionate about continuous learning and engineering efficient, end-to-end technical solutions that are clean, scalable, and built to perform.
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              Email: arnold45khamisi@gmail.com
            </p>
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">Phone: +254 790 243 011</p>
          </div>
          <div>
            <button
              type="button"
        ...
        <section id="skills" className="section-padding bg-slate-950 text-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">My Skills</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {skills.map((skill) => (
                <div key={skill} className="group rounded-[28px] border border-slate-700 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-800 p-6 shadow-[0_24px_80px_-36px_rgba(15,23,42,0.9)] transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl">
                  <div className="flex items-center gap-4">
                    <span className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-pink-500/10 text-pink-300 ring-1 ring-pink-500/20">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fillRule="evenodd" d="M16.704 5.29a1 1 0 00-1.408-1.42L7.5 11.672 4.704 8.88a1 1 0 00-1.408 1.42l4 4a1 1 0 001.408 0l8-8z" clipRule="evenodd" />
                      </svg>
                    </span>
